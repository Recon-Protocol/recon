...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.HashrateInfo"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
        ...
        "/api/v1/intelligence": {
            "get": {
                "description": "Returns the current RECON intelligence score, grade, trend and detected network signals.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Get Kaspa network intelligence",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.Intelligence"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.NetworkSnapshot"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.SupplyInfo"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
